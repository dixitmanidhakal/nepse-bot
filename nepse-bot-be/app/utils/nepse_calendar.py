...
KNOWN_HOLIDAYS_2026 = {
    date(2026, 1, 11),   # Prithvi Jayanti / Shankha Darshan (Sun → auto-skipped but kept for completeness)
    date(2026, 1, 15),   # Maghe Sankranti
    date(2026, 1, 19),   # Sonam Losar
    date(2026, 2, 15),   # Maha Shivaratri (Sun → auto-skipped; SEBON may declare Fri 13 substitute)
    date(2026, 2, 19),   # National Democracy Day
    date(2026, 3, 8),    # Nari Dibas / International Women's Day (Sun → auto-skipped)
    date(2026, 3, 28),   # Ram Nawami (approx; Chaitra Shukla Navami)
    date(2026, 4, 14),   # Nepali New Year (BS 2083 Navabarsha — Baishak 1)
    date(2026, 5, 1),    # Majdoor Divas (Labour Day)
    date(2026, 5, 15),   # Buddha Jayanti / Buddha Purnima (Baishak Purnima, approx)
    date(2026, 5, 27),   # Eid ul-Adha (approx; lunar-based, ±1 day)
    date(2026, 5, 29),   # Ganatantra Diwas (Republic Day — fixed date)
    date(2026, 8, 28),   # Janai Purnima / Raksha Bandhan (Shrawan Purnima, approx)
    date(2026, 9, 5),    # Krishna Janmashtami (approx; Bhadra Krishna Ashtami)
    date(2026, 9, 18),   # Constitution Day substitute (Sep 19 falls on Sat; Fri observed)
    date(2026, 9, 19),   # Constitution Day (Sat → auto-skipped by weekend check)
    date(2026, 10, 11),  # Ghatasthapana (Dashain start, approx; Ashwin Shukla Pratipada)
    date(2026, 10, 17),  # Phulpati / Saptami (Dashain)
    date(2026, 10, 18),  # Maha Astami (Dashain)
    date(2026, 10, 19),  # Maha Nawami (Dashain)
    date(2026, 10, 20),  # Vijaya Dashami (Dashain)
    date(2026, 10, 21),  # Ekadashi (Dashain)
    date(2026, 10, 22),  # Duwadashi / Post-Dashain
    date(2026, 11, 8),   # Laxmi Puja (Tihar)
    date(2026, 11, 9),   # Gobhardan Pujan (Tihar)
    date(2026, 11, 10),  # Bhai Tika (Tihar)
    date(2026, 11, 17),  # Chhath Parwa (approx; Kartik Shukla Shashthi)
}

KNOWN_HOLIDAYS = KNOWN_HOLIDAYS_2025 | KNOWN_HOLIDAYS_2026

DASHAIN_START_DATES = {
    2025: date(2025, 9, 22),   # Ghatasthapana BS 2082
    2026: date(2026, 10, 11),  # Ghatasthapana BS 2083 (approx)
}

TIHAR_START_DATES = {
    2025: date(2025, 10, 20),  # Laxmi Puja BS 2082
    2026: date(2026, 11, 8),   # Laxmi Puja BS 2083 (approx)
}
